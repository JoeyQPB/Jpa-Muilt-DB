...
@Entity
@Table(name = "tb_client_mySQL")
public class Client2 implements IPersistence {
	...
	public Client2(Long id, Long cpf, String name, Long celNumber, Instant createdAt) {
		this.id = id;
		this.cpf = cpf;
		this.name = name;
	...
	public Client2(Long cpf, String name, Long celNumber, Instant createdAt) {
		this.cpf = cpf;
		this.name = name;
		this.celNumber = celNumber;
		this.createdAt = createdAt;
